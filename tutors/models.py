...
class TutoringPlan(models.Model):
    ...
    mon = models.BooleanField(default=True, null=True, blank=True)
    tue = models.BooleanField(default=True, null=True, blank=True)
    wed = models.BooleanField(default=True, null=True, blank=True)
    thur = models.BooleanField(default=True, null=True, blank=True)
    fri = models.BooleanField(default=True, null=True, blank=True)
    sat = models.BooleanField(default=False, null=True, blank=True)
    sun = models.BooleanField(default=False, null=True, blank=True)
